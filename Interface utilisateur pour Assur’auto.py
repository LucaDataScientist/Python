...
engine.execute('INSERT INTO ASSURAUTO.CONTRAT (CO_ID, CO_NUMERO, CO_DATE, CO_CATEGORIE, CO_BONUS, CO_MALUS, CO_AG_ID_FK, CO_CL_ID_FK, CO_VT_ID_FK, CO_VU_ID_FK) VALUES (%s, CURDATE(), "%s", "%s", "%s", "%s", "%s", "%s", "%s", "%s");' %(CO_ID, CO_NUMERO, CO_DATE, CO_CATEGORIE, CO_BONUS, CO_MALUS, CO_AG_ID_FK, CO_CL_ID_FK, CO_VT_ID_FK, CO_VU_ID_FK))
